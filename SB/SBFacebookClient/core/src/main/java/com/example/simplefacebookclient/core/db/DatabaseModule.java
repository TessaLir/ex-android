...
public class DatabaseModule {
	...
	public void deletePost(final String id) throws SQLException {
		final Dao<PostOrm, String> dao = mDatabaseHelper.getDao(PostOrm.class);
		dao.deleteById(id);
	}
	...
	public PostOrm loadPost(final String id) throws SQLException {
		final Dao<PostOrm, String> dao = mDatabaseHelper.getDao(PostOrm.class);
